(function (exports) {
  ...
  function highlightSelection(view) {
    view.dispatch({
  ...
  function unhighlightSelection(view) {
  ...
  const {invertedEffects} = CM["@codemirror/commands"];
...
`,
  ...
  exports.rangeHighlighting = rangeHighlighting;
